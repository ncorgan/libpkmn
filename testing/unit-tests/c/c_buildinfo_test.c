...
{
    const char* libpkmgc_version = pkmn_libpkmgc_version();
...
{
    const char* pksav_version = pkmn_pksav_version();
...
{
    const char* sqlite3_version = pkmn_sqlite3_version();
...
{
    const char* sqlitecpp_version = pkmn_sqlitecpp_version();
