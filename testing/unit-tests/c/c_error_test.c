...
static pkmn_datetime_t dummy_pkmn_datetime_t;
...
static void pokemon_error_test() {
    ...
    /*
     * pkmn_pokemon_get_date_met
     */

    error = pkmn_pokemon_get_date_met(
                NULL, // handle
                false,
                &dummy_pkmn_datetime_t
            );
    TEST_NULL_POINTER_RETURN("handle");
    ...
    TEST_POKEMON_NULL_POINTER_RETURN(pokemon, "datetime_out");

    /*
     * pkmn_pokemon_set_date_met
     */

    error = pkmn_pokemon_set_date_met(
                NULL, // handle
                &dummy_pkmn_datetime_t,
                false
            );
    ...
    TEST_POKEMON_NULL_POINTER_RETURN(pokemon, "nature_out");
    ...
    TEST_POKEMON_NULL_POINTER_RETURN(pokemon, "nature");
...
/*
 * <pkmn-c/types/datetime.h>
 */
static void types_datetime_error_test() {
    /*
     * pkmn_current_datetime
     */

    error = pkmn_current_datetime(
                NULL // datetime_out
            );
    TEST_NULL_POINTER_RETURN("datetime_out");
}
...
PKMN_C_TEST_MAIN(
    ...
    PKMN_C_TEST(types_datetime_error_test)
