...
static void ability_list_test() {
    ...
    TEST_ASSERT_EQUAL_STRING("Adaptability", abilities.strings[0]);
...
static void game_list_test() {
    ...
    TEST_ASSERT_EQUAL_STRING("Red", games.strings[0]);
    TEST_ASSERT_EQUAL_STRING("Alpha Sapphire", games.strings[games.length-1]);
...
static void item_list_test() {
    ...
    TEST_ASSERT_EQUAL(PKMN_ERROR_INVALID_ARGUMENT, error_code);
    ...
    TEST_ASSERT_EQUAL_STRING("Adamant Orb", items.strings[0]);
    TEST_ASSERT_EQUAL_STRING("Zoom Lens", items.strings[items.length-1]);
...
static void location_list_test() {
    ...
    TEST_ASSERT_EQUAL_STRING("Abandoned Ship", locations.strings[0]);
    TEST_ASSERT_EQUAL_STRING("Victory Road", locations.strings[locations.length-1]);
...
static void move_list_test() {
    ...
    TEST_ASSERT_EQUAL_STRING("Pound", moves.strings[0]);
    TEST_ASSERT_EQUAL_STRING("Struggle", moves.strings[moves.length-1]);
...
static void nature_list_test() {
    ...
    TEST_ASSERT_EQUAL_STRING("Hardy", natures.strings[0]);
    TEST_ASSERT_EQUAL_STRING("Quirky", natures.strings[natures.length-1]);
...
static void pokemon_list_test() {
    ...
    TEST_ASSERT_EQUAL_STRING("Bulbasaur", pokemon.strings[0]);
    TEST_ASSERT_EQUAL_STRING("Mew", pokemon.strings[pokemon.length-1]);
...
static void region_list_test() {
    ...
    TEST_ASSERT_EQUAL_STRING("Kanto", regions.strings[0]);
    TEST_ASSERT_EQUAL_STRING("Kalos", regions.strings[regions.length-1]);
...
static void super_training_medal_list_test() {
    ...
    TEST_ASSERT_EQUAL_STRING("Sp. Atk Level 1", super_training_medals.strings[0]);
    TEST_ASSERT_EQUAL_STRING("The Battle for the Best!", super_training_medals.strings[super_training_medals.length-1]);
...
static void type_list_test() {
    ...
    TEST_ASSERT_EQUAL_STRING("Normal", types.strings[0]);
    TEST_ASSERT_EQUAL_STRING("Fairy", types.strings[types.length-1]);
