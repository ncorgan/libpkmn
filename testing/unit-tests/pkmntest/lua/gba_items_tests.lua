...
function gba_items_tests.test_item_bag(bag, game)
    ...
    luaunit.assertEquals(bag["Key Items"][1].item:get_name(), "Mach Bike")
    luaunit.assertEquals(bag["Key Items"][1].amount, 5)
    luaunit.assertEquals(bag["Key Items"][2].item:get_name(), "Wailmer Pail")
    luaunit.assertEquals(bag["Key Items"][2].amount, 5)
    luaunit.assertEquals(bag["Key Items"][3].item:get_name(), "None")
    ...
    luaunit.assertEquals(bag["Poké Balls"][2].item:get_name(), "Master Ball")
    luaunit.assertEquals(bag["Poké Balls"][2].amount, 5)
    luaunit.assertEquals(bag["Poké Balls"][3].item:get_name(), "None")
    luaunit.assertEquals(bag["Poké Balls"][3].amount, 0)

    luaunit.assertEquals(bag[tmhm_pocket_name][1].item:get_name(), "TM01")
    luaunit.assertEquals(bag[tmhm_pocket_name][1].amount, 5)
    luaunit.assertEquals(bag[tmhm_pocket_name][2].item:get_name(), "HM04")
    luaunit.assertEquals(bag[tmhm_pocket_name][2].amount, 5)
    luaunit.assertEquals(bag[tmhm_pocket_name][3].item:get_name(), "None")
    luaunit.assertEquals(bag[tmhm_pocket_name][3].amount, 0)

    luaunit.assertEquals(bag[berry_pocket_name][1].item:get_name(), "Aspear Berry")
    luaunit.assertEquals(bag[berry_pocket_name][1].amount, 5)
    luaunit.assertEquals(bag[berry_pocket_name][2].item:get_name(), "None")
    ...
    luaunit.assertEquals(bag[tmhm_pocket_name][1].item:get_name(), "None")
    luaunit.assertEquals(bag[tmhm_pocket_name][1].amount, 0)
    luaunit.assertEquals(bag[tmhm_pocket_name][2].item:get_name(), "None")
    luaunit.assertEquals(bag[tmhm_pocket_name][2].amount, 0)
    luaunit.assertEquals(bag[tmhm_pocket_name][3].item:get_name(), "None")
    luaunit.assertEquals(bag[tmhm_pocket_name][3].amount, 0)

    luaunit.assertEquals(bag[berry_pocket_name][1].item:get_name(), "None")
