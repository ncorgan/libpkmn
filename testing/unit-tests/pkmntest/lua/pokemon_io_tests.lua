...
function test_3gpkm()
    ...
    luaunit.assertEquals(mightyena:get_original_trainer_name(), "A")
    luaunit.assertEquals(mightyena:get_original_trainer_public_id(), 61415)
    luaunit.assertEquals(mightyena:get_original_trainer_secret_id(), 3417)
    luaunit.assertEquals(mightyena:get_original_trainer_id(), 223997927)
    luaunit.assertEquals(mightyena:get_original_trainer_gender(), "Female")
    luaunit.assertEquals(mightyena:get_current_trainer_friendship(), 254)
