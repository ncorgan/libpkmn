...
namespace pkmntest {
    ...
    PKMN_API void gba_item_pocket_test(
        pkmn::item_list::sptr item_pocket,
        const std::string &game
    );

    PKMN_API void gba_key_item_pocket_test(
        pkmn::item_list::sptr key_item_pocket,
        const std::string &game
    );

    PKMN_API void gba_ball_pocket_test(
        pkmn::item_list::sptr ball_pocket,
        const std::string &game
    );

    PKMN_API void gba_tmhm_pocket_test(
        pkmn::item_list::sptr tmhm_pocket,
        const std::string &game
    );

    PKMN_API void gba_berry_pocket_test(
        pkmn::item_list::sptr tmhm_pocket,
        const std::string &game
    );

    PKMN_API void gba_pc_test(
        pkmn::item_list::sptr pc,
        const std::string &game
    );

    PKMN_API void gba_item_bag_test(
