...
PKMNTEST_API void pkmntest_gba_item_pocket_test(
    pkmn_item_list_handle_t item_pocket,
    const char* game
);

PKMNTEST_API void pkmntest_gba_key_item_pocket_test(
    pkmn_item_list_handle_t key_item_pocket,
    const char* game
);

PKMNTEST_API void pkmntest_gba_ball_pocket_test(
    pkmn_item_list_handle_t ball_pocket,
    const char* game
);

PKMNTEST_API void pkmntest_gba_tmhm_pocket_test(
    pkmn_item_list_handle_t tmhm_pocket,
    const char* game
);

PKMNTEST_API void pkmntest_gba_berry_pocket_test(
    pkmn_item_list_handle_t berry_pocket,
    const char* game
);

PKMNTEST_API void pkmntest_gba_pc_test(
    pkmn_item_list_handle_t pc,
    const char* game
);

PKMNTEST_API void pkmntest_gba_item_bag_test(
