...
PKMN_API void pkmntest_gen2_item_pocket_test(
    pkmn_item_list_handle_t item_pocket,
    const char* game
);

PKMN_API void pkmntest_gen2_key_item_pocket_test(
    pkmn_item_list_handle_t key_item_pocket,
    const char* game
);

PKMN_API void pkmntest_gen2_ball_pocket_test(
    pkmn_item_list_handle_t ball_pocket,
    const char* game
);

PKMN_API void pkmntest_gen2_tmhm_pocket_test(
    pkmn_item_list_handle_t tmhm_pocket,
    const char* game
);

PKMN_API void pkmntest_gen2_pc_test(
    pkmn_item_list_handle_t pc,
    const char* game
);

PKMN_API void pkmntest_gen2_item_bag_test(
