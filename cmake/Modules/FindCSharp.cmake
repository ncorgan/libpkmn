...
IF(WIN32)
    IF("${CMAKE_SIZEOF_VOID_P}" EQUAL "8")
        SET(CSHARP_PLATFORM "x64" CACHE STRING "C# platform" FORCE)
    ELSE()
        SET(CSHARP_PLATFORM "x86" CACHE STRING "C# platform" FORCE)
    ENDIF()
ELSE()
    SET(CSHARP_PLATFORM "anycpu" CACHE STRING "C# platform" FORCE)
ENDIF()
