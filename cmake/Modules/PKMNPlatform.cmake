...
ELSE()
    ...
    SET(PKMN_CONSTEXPR_OR_INLINE "inline")
...
IF(NOT HAVE_MEMORY)
    MESSAGE(FATAL_ERROR "Failed to find required header <memory>.")
ENDIF()
...
IF(MSVC)
    ...
    ENDIF(MSVC12)
ELSEIF(MINGW)
    SET(PKMN_COMPILER_NAME "MinGW-${CMAKE_CXX_COMPILER_ID} ${CMAKE_CXX_COMPILER_VERSION}")
ELSE()
    SET(PKMN_COMPILER_NAME "${CMAKE_CXX_COMPILER_ID} ${CMAKE_CXX_COMPILER_VERSION}")
ENDIF(MSVC)
