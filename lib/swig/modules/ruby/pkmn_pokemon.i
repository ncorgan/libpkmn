...
%rename("trainer_name") get_original_trainer_name;
%rename("trainer_name=") set_original_trainer_name;
%rename("trainer_public_id") get_original_trainer_public_id;
%rename("trainer_public_id=") set_original_trainer_public_id;
%rename("trainer_secret_id") get_original_trainer_secret_id;
%rename("trainer_secret_id=") set_original_trainer_secret_id;
%rename("trainer_id") get_original_trainer_id;
