...
PKMN_PYTHON_ATTRIBUTE_MAPS(pkmn::pokemon, pokemon_numeric_attribute_map, pokemon_string_attribute_map, pokemon_boolean_attribute_map);
PKMN_PYTHON_ATTRIBUTE_MAPS(pkmn::game_save, game_save_numeric_attribute_map, game_save_string_attribute_map, game_save_boolean_attribute_map);
