...
%define PKMN_PYTHON_ATTRIBUTE_MAPS(sptr_type, python_name_numeric, python_name_string)
...
PKMN_PYTHON_ATTRIBUTE_MAPS(pkmn::pokemon, pokemon_numeric_attribute_map, pokemon_string_attribute_map);
