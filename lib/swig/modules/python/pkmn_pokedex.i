...
%attributeval(pkmn::swig::pokedex, %arg(std::vector<pkmn::e_species>), all_seen, get_all_seen);
...
%attributeval(pkmn::swig::pokedex, %arg(std::vector<pkmn::e_species>), all_caught, get_all_caught);
