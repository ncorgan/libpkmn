...
%attributeval(pkmn::swig::pokedex, %arg(std::vector<pkmn::e_species>), AllSeen, get_all_seen);
...
%attributeval(pkmn::swig::pokedex, %arg(std::vector<pkmn::e_species>), AllCaught, get_all_caught);
