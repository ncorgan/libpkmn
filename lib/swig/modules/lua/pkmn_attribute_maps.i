...
%define PKMN_LUA_ATTRIBUTE_MAPS(sptr_type, lua_name_numeric, lua_name_string)
...
PKMN_LUA_ATTRIBUTE_MAPS(pkmn::pokemon, pokemon_numeric_attribute_map, pokemon_string_attribute_map);
