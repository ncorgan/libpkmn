...
%import <lua/pkmn_pokemon_helpers.i>
...
%attribute(pkmn::swig::pokemon, bool, is_egg, get_is_egg, set_is_egg);
...
%attribute(pkmn::swig::pokemon, bool, is_shiny, get_is_shiny, set_shininess);
