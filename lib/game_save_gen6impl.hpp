 ...
 */
#ifndef PKMN_GAME_SAVE_GEN6IMPL_HPP
#define PKMN_GAME_SAVE_GEN6IMPL_HPP
...
namespace pkmn {
    ...
    class game_save_gen6impl: public game_save_impl {
        public:
            game_save_gen6impl() {};
            explicit game_save_gen6impl(
        ...
        private:
            pksav_gen6_save_t _pksav_save;
    };

}

#endif /* PKMN_GAME_SAVE_GEN6IMPL_HPP */
