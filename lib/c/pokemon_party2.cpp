...
pkmn_error_t pkmn_pokemon_party2_init(
    const char* game,
...
pkmn_error_t pkmn_pokemon_party2_free(
...
const char* pkmn_pokemon_party2_strerror(
    pkmn_pokemon_party2_t* pokemon_party_ptr
)
{
...
pkmn_error_t pkmn_pokemon_party2_get_num_pokemon(
    pkmn_pokemon_party2_t* pokemon_party_ptr,
...
pkmn_error_t pkmn_pokemon_party2_get_pokemon(
    pkmn_pokemon_party2_t* pokemon_party_ptr,
    size_t position,
...
pkmn_error_t pkmn_pokemon_party2_set_pokemon(
    pkmn_pokemon_party2_t* pokemon_party_ptr,
    size_t position,
...
pkmn_error_t pkmn_pokemon_party2_as_list(
    pkmn_pokemon_party2_t* pokemon_party_ptr,
